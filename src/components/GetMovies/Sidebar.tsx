                ...
                <Offcanvas.Body>
                    <div className={'p-2'}>
                        ...
                        <DropdownButton title={'Genre'} drop={'end'}>
                            ...
                            <Dropdown.Item as={'button'} onClick={() => props.filterByGenre(10751)}>Family</Dropdown.Item>
                            ...
                            <Dropdown.Item as={'button'} onClick={() => props.filterByGenre(10749)}>Romance</Dropdown.Item>
